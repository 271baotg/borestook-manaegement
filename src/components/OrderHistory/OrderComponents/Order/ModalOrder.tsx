...
const ModalOrder: React.FC<{currentOrder: OrderModel | undefined, orderDetailItems: OrderDetailModel[]}> = (props) =>{
                        ...
                        <table className={`${st.table}`}>
                            ...
                            <tbody className={st.tbody}>
                                <tr className={st.tableRow}>
                                        ...
                                        <td className={st.tableData}>{props.currentOrder.customer.spent}</td>
                                        <td className={st.tableData}>{props.currentOrder.customer.phoneNumber}</td>
                                        <td className={`${st.tableData} text-primary`}>
                                            {props.currentOrder.customer.fullName}
                                        </td>
                                        <td className={st.tableData}>{props.currentOrder.customer.ranking}</td>
                                        <td className={st.tableData}>{formattedCustomerDate}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
