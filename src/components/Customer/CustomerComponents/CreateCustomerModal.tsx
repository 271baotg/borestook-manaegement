                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-success" onClick={handleOnClickCreatButton}>Create</button>
            ...
            <div className="modal fade" id="createCustomerConfirmModal" aria-hidden="true" aria-labelledby="createCutomerConfirmLabel" tabIndex={-1}>
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-primary" style={{ minWidth: '100px' }} onClick={handleOnClickConfirmButton}>Save</button>
