...
export const BookTable: React.FC<{ bookList: BookModel[], addToBill: Function, searchKeyWord:string, setSearchKeyWord:Function }> = (props) => {
  return (
    <main className={st.tableContainer}>
      <section className={st.table__header}>
        <h1>Books</h1>
        <SearchBar searchKeyWord={props.searchKeyWord} setSeachKeyWord={props.setSearchKeyWord}></SearchBar>
      </section>
